    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li <c:if test="${fn:contains(pageContext.request.servletPath, 'before')}">class="active"</c:if>><a href="${contextPath}/blog">Before Sandy</a></li>
                <li <c:if test="${fn:contains(pageContext.request.servletPath, 'rebuild')}">class="active"</c:if>><a href="${contextPath}/about">The Rebuild</a></li>
                <li <c:if test="${fn:contains(pageContext.request.servletPath, 'after')}">class="active"</c:if>><a href="${contextPath}/resume">Current</a></li>
